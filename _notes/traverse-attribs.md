...
![The finished result](/assets/notes/traversal-attrib/travesal_attrib.gif)

This example starts with a 2D curve network. Th input to the FindShortestPathSOP is created via a circleSOP and a VoronoiFractureSOP, with a bias favouring end points further away from the origin.
